                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            <form class="forms-sample" method="POST" action="{{ route('backend.obres.store') }}" enctype="multipart/form-data" novalidate>
                                @csrf
                                @error('categoria')
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="categoria" name="categoria" class="form-control js-example-basic-single w-100">
                                        <option value="Pintura"
                                            {{ old('actiu') == "Pintura" ? 'selected' : '' }}
                                        >
                                            Pintura
                                        </option>
                                        <option value="Ceràmica"
                                            {{ old('actiu') == "Ceràmica" ? 'selected' : '' }}
                                        >
                                            Ceràmica
                                        </option>
                                        <option value="Il·lustració"
                                            {{ old('actiu') == "Il·lustració" ? 'selected' : '' }}
                                        >
                                            Il·lustració
                                        </option>
                                    </select>
